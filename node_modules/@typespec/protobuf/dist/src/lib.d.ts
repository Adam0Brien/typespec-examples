...
}, ProtobufEmitterOptions, never>;
export type Diagnostic = Parameters<typeof TypeSpecProtobufLibrary.reportDiagnostic>[1];
export declare const reportDiagnostic: (<C extends "field-index" | "field-name" | "root-operation" | "unsupported-intrinsic" | "unsupported-return-type" | "unsupported-input-type" | "unsupported-field-type" | "namespace-collision" | "unconvertible-enum" | "nested-array" | "invalid-package-name" | "illegal-reservation" | "model-not-in-package" | "anonymous-model" | "unspeakable-template-argument" | "package", M extends keyof {
    "field-index": {
        readonly missing: import("@typespec/compiler").CallableMessage<["name"]>;
        readonly invalid: import("@typespec/compiler").CallableMessage<["index"]>;
        readonly "out-of-bounds": import("@typespec/compiler").CallableMessage<["index", "max"]>;
     ...
     */
    once: (program: Program, diagnostic: Diagnostic & {
        target: DiagnosticTarget;
    }) => void;
};
export type TypeSpecProtobufLibrary = typeof TypeSpecProtobufLibrary;
declare const keys: readonly ["fieldIndex", "package", "service", "externRef", "stream", "reserve", "message", "_map"];
export declare const state: { [K in (typeof keys)[number]]: symbol; };
export {};
